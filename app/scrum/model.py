...
class clsBacklog(db.Model):
    ...
    BL_refObjective = db.relationship('clsObjective', backref='backlog', lazy='dynamic',
    ...
    BL_refUserHist = db.relationship('clsUserHistory', backref='backlog', lazy='dynamic',
                                     cascade="all, delete, delete-orphan")
...
class clsActor(db.Model):
    ...
    A_refActorsUserHist = db.relationship('clsActorsUserHistory', backref='actors', lazy='dynamic',
                                          cascade="all, delete, delete-orphan")
...
class clsObjective(db.Model):
    ...
    O_refObjUserHist = db.relationship('clsObjectivesUserHistory', backref='objectives', lazy='dynamic',
                                       cascade="all, delete, delete-orphan")
...
class clsAccion(db.Model):
    ...
    AC_refUserHistory = db.relationship('clsUserHistory', backref='accions', lazy='dynamic',
                                        cascade="all, delete, delete-orphan")
...
class clsUserHistory(db.Model):
    ...
    UH_refActorsUserHist = db.relationship('clsActorsUserHistory', backref='userHistory', lazy='dynamic',
                                           cascade="all, delete, delete-orphan")
    UH_refTareaUserHist = db.relationship('clsTask', backref='userHistory', lazy='dynamic',
                                          cascade="all, delete, delete-orphan")
...
class clsCategory(db.Model):
    ...
    C_refTaskCategory = db.relationship('clsTask', backref='category', lazy='dynamic',
                                        cascade="all, delete, delete-orphan")
