...
scrumModule.controller('VCrearObjetivoController', 
   ['$scope', '$location', '$route', '$timeout', 'flash', '$routeParams', 'identService', 'objetivoService', 'prodService',
    function ($scope, $location, $route, $timeout, flash, $routeParams, identService, objetivoService, prodService) {
      $scope.msg = '';
      $scope.fObjetivo = {};
